# -*- encoding: utf-8 -*-
# stub: activerecord-jdbcpostgresql-adapter 1.3.21 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activerecord-jdbc-adapter>.freeze, ["~> 1.3.21"])
      s.add_runtime_dependency(%q<jdbc-postgres>.freeze, [">= 9.1"])
    else
      s.add_dependency(%q<activerecord-jdbc-adapter>.freeze, ["~> 1.3.21"])
